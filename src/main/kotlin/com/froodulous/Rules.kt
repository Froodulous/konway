 ...
 *
 * @param bornNumbers The Set of numbers which, if a dead cell has that many living neighbours, causes that cell to be
 ...
 * neighbours.
 */
fun Rules.survives(numNeighbours: Int) = surviveNumbers.contains(numNeighbours)
